...
- Interpretation (simple and multivariate case)
...
$$
  energy\_costs_i = \beta_0 + \beta_1 England_i + \beta_2 Wales_i + \beta_3 Scotland_i + \beta_4 NIreland_i + u_i
$$

for a sample of UK households. Where, 

- $[England_i, Wales_i, Scotland_i, NIreland_i]$ are all 'dummy' variables denoting the location of household $i$. 
...
Suppose you started with the data? For example, the [Living Costs and Food Survey](https://datacatalogue.ukdataservice.ac.uk/series/series/2000028#abstract): 

- a *household level* dataset with information on consumption and income. 
