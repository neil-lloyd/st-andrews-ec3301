...
For this lab you will be using a dataset supplied by the UK Data Service. Before using the dataset, you need to do the following:

1. Go to [UK Data Service](https://beta.ukdataservice.ac.uk/myaccount/login) registration page
2. Type in and select "University of St Andrews"
3. Complete the registration form. 

This then entitles you to access the data via Moodle. 

4. Agree to the [Data Access Quiz](https://moody.st-andrews.ac.uk/moodle/mod/quiz/view.php?id=1563763) on Moodle.

Upon submitting the quiz, you will be shown a link to the data.

5. Download both the "shs2023.dta" and "shs2023.csv" files. 
:::
