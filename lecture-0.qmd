...
1.  "Econometrics is the most important module you will take in Economics" (Dr Neil Lloyd, 10 September 2026)
    ...
    - Basis of *most* Applied Economics: Labour, Development, Trade, etc.
    - Requirement for most MSc Economics degrees

2.  Lecture attendance matters, but probably not for the reasons you think

    - Conditioning: think marathon training. 
    - Attending lectures is akin to a well-paced training regimen
...
> "Econometrics is based upon the development of statistical methods for estimating economic relationships, testing economic theories, and evaluating and implementing government and business policy." [@wooldridge2025, pp. 2]
...
[^1]: Linked to the idea of economic significance and used in cost-benefit analysis.
...
![](material/lecture-0/Stata-vs-R.png){fig-align="center"}
...
::::: columns
::: {.column width="50%"}
![](material/lecture-0/logo-Stata.jpeg){width=40%}

- easy to learn and use
- intuitive GUI
- `.dta` data format
- simple command-based 'language'
- programming *light*
:::
::: {.column width="50%"}
![](material/lecture-0/logo-R.jpeg){width=40%}
...
::: incremental
1. **Attend class:** lectures, labs, tutorials

2. **Engage:** ask questions, provoke discussion, *question everything*

3. **Listen:** keep track of what the instructor emphasizes

4. **Keep up:** follow up on things you don't understand

5. **Collaborate:** $\text{teaching}=\max\{\text{learning}\}$

6. **Use LLMs smartly:** beware the false sense of 'learning'
:::
